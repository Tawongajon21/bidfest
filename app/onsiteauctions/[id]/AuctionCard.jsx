...
function AuctionCard({auctionType,key,lotImages,item,previousPathName,userBids,bids,id,auctionId,auctionDate,auctionDeadline, auctionTime ,propertyName,currentPrice}) {
