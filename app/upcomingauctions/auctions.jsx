...
export default function AuctionClient({data,auctionType,isLoading}) {
    console.log(data);
...

{
  ...
  <h5 className='text-xl font-semibold mb-4 flex justify-between align-middle items-center'>
    <span>
    Auction Type
    </span>
    <span>
